...
class RegistrationController extends AbstractController
{
     ...
     */
    public function verifyUserEmail(Request $request, TranslatorInterface $translator, FlashyNotifier $flashy): Response
    {
       ...
       // $this->addFlash('success', 'Your email address has been verified.');
        $flashy->success('Votre adresse e-mail a été vérifiée.');
        return $this->redirectToRoute('app_publications');
    }
}
